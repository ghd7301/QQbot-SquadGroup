...
squad-qqbot-mvp/
  ...
  squad_bot/
    ...
    delivery/
      ...
      review.py     发送校验、回复安全、最终复审和迟到上下文刷新
    ingress/
    ...
    worker_runtime.py 队列 worker 循环、pending 生命周期和优先级让行规则
...
SEMANTIC_PLANNER_ADDRESSED_TIMEOUT_SECONDS=6
SEMANTIC_PLANNER_MIN_CONFIDENCE=0.68
SEMANTIC_PLANNER_CONTEXT_MESSAGES=10
SEMANTIC_PLANNER_CONTEXT_MAX_CHARS=3200
SEMANTIC_PLANNER_MEMORY_MAX_CHARS=800
SEMANTIC_PLANNER_CIRCUIT_FAILURES=5
